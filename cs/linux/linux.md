...
按 i 或者 a 进去 insert append模式

按 esc 进入底线命令模式 ，输入`：wq` 保存并退出
...
![img](https://img.amazingtm.com/201903/08024010.png)
...
![](https://img.amazingtm.com/201903/08023833.png-sign)
...
ctrl+c 结束正在前台运行的程序（ping telnet等）
...
![](https://img.amazingtm.com/201903/08035015.png-sign)

知识：业务知识、开发知识（语言本身知识、底层原理知识）
